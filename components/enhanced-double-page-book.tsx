...
export function EnhancedDoublePageBook() {
                  ...
                  {leftPage ? (
                    <>
                      ...
                      <div className="absolute left-0 top-0 bottom-0 w-4 pointer-events-none">
                        <div className="absolute inset-0 bg-gradient-to-r from-stone-200/30 to-transparent"></div>
                      </div>
                    </>
                  ) : (
                  ...
                  {rightPage ? (
                    <>
                      ...
                      <div className="absolute right-0 top-0 bottom-0 w-4 pointer-events-none">
                        <div className="absolute inset-0 bg-gradient-to-l from-stone-200/30 to-transparent"></div>
                      </div>
                    </>
                  ) : (
          ...
          {isAnimating && (
            ...
            >
              ...
              <div
                ...
                style={{
                  boxShadow: direction > 0 ? "inset -5px 0 15px rgba(0,0,0,0.1)" : "inset 5px 0 15px rgba(0,0,0,0.1)",
                  backfaceVisibility: "hidden",
                }}
              />
              <div

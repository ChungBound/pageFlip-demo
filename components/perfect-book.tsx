          ...
          <div className="absolute inset-4 bg-stone-100 rounded shadow-inner z-20 overflow-hidden">
            ...
            {!isAnimating && (
              <div className="absolute inset-0 flex">
                {/* 左侧页面 */}
                <div className="w-1/2 h-full bg-stone-50 p-8 flex flex-col">
                  {leftPage ? (
                    <>
            ...
            <AnimatePresence>
              {isAnimating && direction > 0 && (
                <>
                  {/* 当前左侧页面 */}
                  <div className="absolute top-0 left-0 bottom-0 w-1/2 bg-stone-50 p-8 flex flex-col z-20">
                    {leftPage && (
                      <>
                        <div className="flex-1 flex items-center justify-center">
                          <div className="max-w-xs">
                  ...
                  {/* 下一组右侧页面 */}
                  <div className="absolute top-0 right-0 bottom-0 w-1/2 bg-stone-50 p-8 flex flex-col z-20">
                    {nextRightPage && (
                      <>
                        <div className="flex-1 flex items-center justify-center">
                          <div className="max-w-xs">
